...
import { Plus, Send, TrendingUp, Mail, MousePointer2, ExternalLink } from "lucide-react";
import { 
  Table, 
  TableBody, 
  TableCell, 
...
export default function CampaignsPage() {
  const stats = {
    ...
    sent: MOCK_CAMPAIGNS.reduce((acc, c) => acc + c.stats.sent, 0),
    replied: MOCK_CAMPAIGNS.reduce((acc, c) => acc + c.stats.replied, 0),
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-muted-foreground mt-1">2 Active this month</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <TableCell>
                    <div className="space-y-1 w-[120px]">
                      <div className="flex justify-between text-[10px]">
                        <span>{campaign.stats.replied} Replies</span>
